...
3.  创建账号，具体操作请参见[t16843.md\#](/cn.zh-CN/快速入门/设置账号.md)。

    **说明：** 该账号用于登录DMS，每个实例只能创建一个。

4.  单击实例详情页右上角**登录数据库**。

    ![](https://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/zh-CN/8629919951/p50990.png)
...
6.  若有页面弹出如下提示，请根据当前情况选择相应设置。
    ...
    ![](https://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/zh-CN/9629919951/p50991.png)
