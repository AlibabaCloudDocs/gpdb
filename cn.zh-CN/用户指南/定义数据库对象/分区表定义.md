...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/217571/156267504251129_zh-CN.jpg)
...
请对多级分区格外谨慎，因为分区文件的数量可能会增长得非常快。例如，如果一个表被按照日和城市划分并且有1,000个日以及1,000个城市，那么表分区的总数就是一百万。特别对于列存表，会把每一列存在一个物理表中，因此如果这个表有100个列，系统就需要为该表管理一亿个文件。
