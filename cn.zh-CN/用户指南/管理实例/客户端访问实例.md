# 客户端访问实例 {#concept_ncj_gmr_52b .concept}
...
4.  单击实例详情页右上角**登录数据库**。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16845/156272793150990_zh-CN.png)
...
6.  若有页面弹出如下提示，请根据当前情况选择相应设置。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16845/156272793250991_zh-CN.png)
