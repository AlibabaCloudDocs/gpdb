# Amazon Redshift应用和数据迁移至AnalyticDB for PostgreSQL
...
2.  将Amazon S3数据同步到OSS中。
    ...
    3.  配置单机模式的ossimport，请参考如下示例修改配置文件conf/local\_job.cfg，关于ossimport配置的详细信息，请参见[说明及配置](/cn.zh-CN/常用工具/数据迁移工具ossimport/说明及配置.md)。
