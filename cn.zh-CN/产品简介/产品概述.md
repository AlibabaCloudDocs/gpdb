...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/16833/156678725557459_zh-CN.png)

AnalyticDB for PostgreSQL采用MPP架构，实例由多个[计算节点](cn.zh-CN/产品简介/名词解释.md#)组成，可线性扩展。包括的组件有 ：
