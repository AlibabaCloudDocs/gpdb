...
|类别|名称|描述|相关文档|
|--|--|--|----|
|新增|Laser引擎|AnalyticDB PostgreSQL版默认打开Laser引擎。|[Laser计算引擎的使用](/cn.zh-CN/开发进阶/高级扩展插件使用/Laser计算引擎的使用.md)|
|并行查询|AnalyticDB PostgreSQL版单表查询默认打开并行查询。|[并行查询](/cn.zh-CN/开发入门/并行查询.md)|
...
|[排序加速计算](/cn.zh-CN/开发入门/排序加速计算.md)|
|备份恢复|Multi-Master架构的AnalyticDB PostgreSQL版支持备份恢复功能。|-   [功能介绍](/cn.zh-CN/实例管理/备份恢复/功能介绍.md)
-   [数据备份](/cn.zh-CN/实例管理/备份恢复/数据备份.md)
-   [数据恢复](/cn.zh-CN/实例管理/备份恢复/数据恢复.md) |
|查询内核版本|新增GUC参数用于查询AnalyticDB PostgreSQL版内核版本，语句如下：```
show adbpg_version;
```

|[查看内核小版本](/cn.zh-CN/实例管理/版本管理/查看内核小版本.md)|
|优化|实时物化视图|实时物化视图性能增强。聚合操作MAX和MIN支持了DELETE和UPDATE；支持对基表的变更语句使用CTE。|[实时物化视图（Beta）](/cn.zh-CN/数据管理/实时物化视图（Beta）.md)|
