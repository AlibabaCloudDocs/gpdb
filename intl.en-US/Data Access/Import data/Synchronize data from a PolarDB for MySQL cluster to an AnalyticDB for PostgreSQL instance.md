...
8.  Select the synchronization policy and the objects to be synchronized.
    ...
    ![Synchronize data from MySQL to AnalyticDB for PostgreSQL](https://static-aliyun-doc.oss-accelerate.aliyuncs.com/assets/img/en-US/7289831261/p96654.png)
...
12. Wait until the initial synchronization is complete and the data synchronization task is in the **Synchronizing** state.
    ...
    ![View the status of a data synchronization task](https://static-aliyun-doc.oss-accelerate.aliyuncs.com/assets/img/en-US/5464738161/p41059.png)
